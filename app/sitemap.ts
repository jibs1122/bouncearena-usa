...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/vuly-promo-code/`, lastModified: new Date("2026-06-25"), changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/acon-promo-code/`, lastModified: new Date("2026-06-25"), changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/zupapa-promo-code/`, lastModified: new Date("2026-06-25"), changeFrequency: "weekly", priority: 0.7 },
