...
title: ACON vs MaxAir — Trampoline Comparison 2026 | Bounce Arena
---

# ACON vs MaxAir

ACON and MaxAir aren't shopped on the same budget, and that gap is the whole point.
...
- MaxAir caps a single jumper at 250 lb; ACON publishes no hard cap and recommends about 300 lb.
- Both make rounds and rectangles; MaxAir adds squares.
...
- Installation differs: ACON is mainly above-ground with an in-ground option, while MaxAir is above- or in-ground.
