...
export const SKYBOUND_COMPARISON_DEFINITIONS: ComparisonDefinition[] = [
  {
    ...
    metaDescription: "SkyBound vs Skywalker: online value range vs retail default. Compare warranties, spring systems, parts support, and model tiers.",
    introParagraphs: [
      "SkyBound and Skywalker overlap in the family-backyard price band, but they are not the same kind of brand. Skywalker is the familiar retail default with broad parts availability; SkyBound is an online range that grew out of replacement parts and now spans budget coil models, mid-tier coil lines, the Stratos/StratosPro round lines, rectangles, and a springless line.",
      "Skywalker keeps the lineup simpler: mostly coil-spring rounds plus square, oval, and rectangle models, with a patented no-gap enclosure and wide availability through Amazon, Walmart, Target, and Skywalker's own parts catalog.",
      "Choose Skywalker if easy retail buying and long-term parts access matter most. Choose SkyBound if you want more design variety at online-brand prices, especially if a springless option or SkyBound's AltitudeX rectangle is on your list.",
    ],
    intro: "SkyBound and Skywalker overlap in the family-backyard price band, but they are not the same kind of brand.",
    specTableKeyTakeaways: [
      "On full-size rounds, the two brands start close: Skywalker 10 ft rounds sit around $249, while SkyBound's 10 ft coil rounds run roughly $240-$270 depending on line.",
      "Weight ratings are model-tier specific: Skywalker standard rounds sit around 175-275 lb, Epic rounds list 400 lb, and the Premium Olympic rectangle lists 625 lb; SkyBound's mainstream published single-jumper ratings run 220-330 lb.",
      "Frame warranties overlap by tier: SkyBound is 5 years on most lines and 10 years on AltitudeX; Skywalker is 3 years on standard models and 10 years on Epic and Premium.",
      "Skywalker adds ovals to the round, rectangle, and square shapes both brands sell.",
    ],
    keyTakeaways: [
      "Lineup: SkyBound is more mixed, with replacement parts, budget coil rounds, AiryBounce/SkyRise/SkyLift/SkySoar coil models, Stratos/StratosPro rounds, the AltitudeX rectangle, and a springless line. Skywalker is primarily a coil-spring retail range.",
      "Warranty coverage: SkyBound's Springless line is 5 years across the listed parts, AiryBounce is 5 years frame with 3-year mat and spring coverage, SkyLift/SkyRise/SkySoar are 5 years frame with 2-year parts coverage, and AltitudeX is 10 years frame with 2-year mat and spring coverage. Skywalker standard models are 3 years frame and 1 year parts, while Epic and Premium move to 10-year frames.",
      "Weight limits: Standard Skywalker rounds list about 175-275 lb per jumper, while mainstream SkyBound published limits sit around 220-330 lb. Skywalker's Olympic rectangle is the outlier at 625 lb and should be compared as that specific Premium model, not as a brand-wide rating.",
      "Parts availability: Skywalker replacement parts are the easiest to find of any US brand, sold through Skywalker itself, big-box retailers, and third parties, including SkyBound's parts catalog.",
  ...
  },
  {
    ...
    metaDescription: "SkyBound vs Zupapa: warranty length, real jumper limits, springless vs coil options, and what 1500LBS model names mean.",
    introParagraphs: [
  ...
  },
  {
    ...
    metaDescription: "SkyBound vs ORCC: warranty terms, jumper limits, springless vs coil designs, and round vs oval options across budget online brands.",
    introParagraphs: [
  ...
  },
  {
    ...
    metaDescription: "SkyBound vs ACON: value range vs premium performance. Compare warranty coverage, bounce quality, and jumper limits.",
    introParagraphs: [
      "SkyBound and ACON are both coil-spring trampoline brands sold online, but they sit in completely different tiers. ACON builds for serious, sustained jumping backed by long warranties; SkyBound covers the family-backyard use case at a fraction of the cost.",
      "ACON's range covers the Air series rounds ($899–$1,599) and the HD and X rectangles ($1,899–$3,999) aimed at gymnasts and serious jumpers, with higher spring counts and heavy-gauge frames. Warranty coverage is 10 years on the frame and 5 years on the mat and springs. ACON recommends around a 300 lb jumper limit and doesn't publish a hard weight cap on most models.",
    ...
    intro: "SkyBound and ACON are both coil-spring trampoline brands sold online, but they sit in completely different tiers.",
    specTableKeyTakeaways: [
      ...
      "ACON publishes no hard single-jumper cap and recommends around 300 lb, while SkyBound publishes explicit 220-330 lb limits per model.",
    ...
    keyTakeaways: [
      "Build tier: ACON is a performance brand with heavier frames, higher spring counts, and gymnastics-grade rectangles. SkyBound is a value brand with budget coil rounds, mid-tier coil lines, the AltitudeX rectangle, and a springless line.",
      "Warranty: ACON covers frames for 10 years and mats and springs for 5, against SkyBound's 5-year frame and 2-3 year mat and spring coverage on most coil lines.",
      "Price: SkyBound's range mostly sits between $150 and $700, while ACON starts at $899 and its rectangles reach $3,999.",
      "Bounce performance: ACON's longer springs and higher spring counts (up to 140 on the 16 HD) deliver a deeper, more consistent bounce across the range. SkyBound's AltitudeX rectangle is its only model built to compete at that level — the rest of the lineup is recreational-grade.",
      ...
      "Verdict: Choose ACON if the trampoline needs to handle serious, sustained jumping. Choose SkyBound if the goal is a family-backyard trampoline at a much lower price.",
    ],
  },
  {
    ...
    metaDescription: "SkyBound vs Jumpflex: warranty tiers, HERO ratings, springless vs coil options, and where the extra Jumpflex spend goes.",
    introParagraphs: [
